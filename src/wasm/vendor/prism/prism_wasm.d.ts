 ...
 */
export function render_fused_loop_lengths(a_flat: Float32Array, a_channels: number, b_flat: Float32Array, b_channels: number, sample_rate: number, freeze_point_a_pct: number, volume_a_pct: number, tune_a_semitones: number, formant_shift_a_semitones: number, mode: string, freeze_point_b_pct: number, formant_shift_b_semitones: number, volume_b_pct: number, tune_b_semitones: number, mix_amount_pct: number, cross_synth_amount_pct: number, convolve_amount_pct: number, ring_mod_amount_pct: number, stereo_width_pct: number, loop_length_seconds: number, tracks_flat: Float32Array, num_points: number, track_mask: number, num_segments: number, crossfade_seconds: number): object;
 ...
 */
export function render_microtextures(fused_flat: Float32Array, fused_channels: number, sample_rate: number, root_note: number, grain_seconds: number, density_hz: number, jitter: number, reverse_probability: number, pitch_scatter_semitones: number, pan_scatter: number, volume_variance: number, density_mod_rate_hz: number, density_mod_depth: number, grain_chaos: number, retrigger_hz: number, retrigger_amount: number, bit_depth: number, downsample: number, formant_shift_semitones: number, formant_resonance: number, formant_mix: number): object;

export function render_percussion(fused_flat: Float32Array, fused_channels: number, sample_rate: number, root_note: number, noise_amount_pct: number, noise_color: string, noise_decay_seconds: number, transient_amount_pct: number, transient_decay_seconds: number, transient_frequency_hz: number, pitch_start_semitones: number, pitch_end_semitones: number, pitch_decay_seconds: number, amp_decay_seconds: number, body_amount_pct: number, partial_count: number, partial_decay_seconds: number, digital_amount_pct: number, drive_amount_pct: number, compress_amount_pct: number, stereo_width_pct: number, length_seconds: number): object;
...
export interface InitOutput {
    ...
    readonly render_microtextures: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => [number, number, number];
    readonly render_percussion: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number, x: number) => [number, number, number];
